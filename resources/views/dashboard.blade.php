...
@section('title', 'KeKeM [Kelah Keluh Masyarakat] - Dashboard')
@section('container')
                    ...
                    <div class="col">
                        <div class="card shadow xl-14">
                                ...
                                @if(Session::get('level')=='admin')
                                    <p>Selamat Datang di Admin Page, Anda sebagai Admin disini</p>
                                @else
                                    <p>Selamat Datang di Admin Page, Anda sebagai Petugas disini</p>
                                @endif
                                </div>
                            </div>
                        </div> 
