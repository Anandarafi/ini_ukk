...
<body> 
	...
	<div class="container">
		<div class="placeholder">
			<div class="parallax-window" data-parallax="scroll" data-image-src="{{url('tmp/img/simple-house-01.jpg')}}">
				<div class="tm-header">
					<div class="row tm-header-inner">
						<div class="col-md-6 col-12">
							<div class="tm-site-text-box">
								<h1 class="tm-site-title">KeKeM</h1>
								<h6 class="tm-site-description">Keluh Kesah Masyarakat</h6>	
							</div>
						</div>
		...
		<footer class="tm-footer text-center">
			<p>Copyright &copy; 2021 KeKeM
            
            | Ananda Rafi Amanullah [XII RPL 7 / 04]</p>
		</footer>
