...
class PengaduanController extends Controller
{
    ...
    {
        Session::get('nik');
        $data['datas']=PengaduanModel::join('masyarakat','masyarakat.nik','pengaduan.nik')->get(); 
    ...
    {
        $data = PengaduanModel::where('id_pengaduan', $id)->get();
        return view('pengaduan.edit_pengaduan',['pengaduan'=>$data]);
    }
    
    public function detail($id)
    {
        $data = PengaduanModel::where('id_pengaduan', $id)->join('masyarakat','masyarakat.nik','pengaduan.nik')->get();
