...
class TanggapanController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        if($data){
            return redirect()->action('TanggapanController@index')->with('alert_message', 'Berhasil Mengubah Data');
        }else{
            return redirect()->action('TanggapanController@index')->with('alert_message', 'Gagal Mengubah Data');
        }
